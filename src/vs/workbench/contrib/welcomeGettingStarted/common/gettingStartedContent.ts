...
const CopilotStepTitle = localize('gettingStarted.copilotSetup.title', "Connect OpenGravity Agent");
const CopilotDescription = localize({ key: 'gettingStarted.copilotSetup.description', comment: ['{Locked="["}', '{Locked="]({0})"}'] }, "OpenGravity Agent uses your own provider accounts to plan, review, edit, and run coding workflows with explicit approvals.", defaultChat.documentationUrl ?? '');
const CopilotTermsString = localize({ key: 'gettingStarted.copilotSetup.terms', comment: ['{Locked="]({2})"}', '{Locked="]({3})"}'] }, "By connecting a provider, you agree to that provider's terms and privacy policy.", defaultChat.provider.default.name, defaultChat.provider.default.name, defaultChat.termsStatementUrl, defaultChat.privacyStatementUrl);
const CopilotAnonymousButton = Button(localize('setupCopilotButton.setup', "Connect Provider"), `command:opengravity.connectProvider`);
const CopilotSignedOutButton = Button(localize('setupCopilotButton.setup', "Connect Provider"), `command:opengravity.connectProvider`);
const CopilotSignedInButton = Button(localize('setupCopilotButton.setup', "Connect Provider"), `command:opengravity.connectProvider`);
const CopilotCompleteButton = Button(localize('setupCopilotButton.chatWithCopilot', "Open Agent"), 'command:opengravity.openAgent');
...
function createCopilotSetupStep(id: string, button: string, when: string, includeTerms: boolean): BuiltinGettingStartedStep {
	...
	return {
		...
		media: {
			type: 'svg', altText: 'OpenGravity Agent multi file edits', path: 'multi-file-edits.svg'
		},
	};
}
...
export const walkthroughs: GettingStartedWalkthroughContent = [
	{
		id: 'Setup',
		title: localize('gettingStarted.setup.title', "Get started with OpenGravity"),
		description: localize('gettingStarted.setup.description', "Customize your editor, learn the basics, and start coding"),
		isFeatured: true,
		icon: setupIcon,
		when: '!isWeb',
		walkthroughPageTitle: localize('gettingStarted.setup.walkthroughPageTitle', 'Setup OpenGravity'),
		next: 'Beginner',
		content: {
			type: 'steps',
			steps: [
				...
				},
				{
					...
					description: localize('gettingStarted.videoTutorial.description.interpolated', "Watch the first in a series of short practical video tutorials for OpenGravity's core IDE features.\n{0}", Button(localize('watch', "Watch Tutorial"), 'https://aka.ms/vscode-getting-started-video')),
	...
	{
		id: 'SetupWeb',
		title: localize('gettingStarted.setupWeb.title', "Get Started with OpenGravity for the Web"),
		description: localize('gettingStarted.setupWeb.description', "Customize your editor, learn the basics, and start coding"),
		isFeatured: true,
		icon: setupIcon,
		when: 'isWeb',
		next: 'Beginner',
		walkthroughPageTitle: localize('gettingStarted.setupWeb.walkthroughPageTitle', 'Setup OpenGravity Web'),
		content: {
			type: 'steps',
			steps: [
				{
	...
	},
	{
		...
		next: 'Setup',
		walkthroughPageTitle: localize('gettingStarted.setupAccessibility.walkthroughPageTitle', 'Setup OpenGravity Accessibility'),
		content: {
			type: 'steps',
			steps: [
				{
